...
if turn <= 3 and (jeu.arrayGrid[x + cellX - 2 ,y + cellY - 2 ] != [1,1] ) or\
                (jeu.arrayGrid[x + cellX - 2 ,y + cellY - 2 ] != [1,18] ) or\
                (jeu.arrayGrid[x + cellX - 2 ,y + cellY - 2 ] != [18,1] ) or \
                (jeu.arrayGrid[x + cellX - 2 ,y + cellY - 2 ] != [18,18] ):
...
jeu.arrayGrid[x + cellX - 2 - 1][y + cellY - 2 - 0] != player.initial or \
                    jeu.arrayGrid[x + cellX - 2 + 1][y + cellY - 2 - 0] != player.initial or \
                    jeu.arrayGrid[x + cellX - 2 - 1][y + cellY - 2 + 0] != player.initial or \
                    jeu.arrayGrid[x + cellX - 2 + 1][y + cellY - 2 + 0] != player.initial or \
                    jeu.arrayGrid[x + cellX - 2 - 0][y + cellY - 2 - 1] != player.initial or \
                    jeu.arrayGrid[x + cellX - 2 + 0][y + cellY - 2 - 1] != player.initial or \
                    jeu.arrayGrid[x + cellX - 2 - 0][y + cellY - 2 + 1] != player.initial or \
                    jeu.arrayGrid[x + cellX - 2 + 0][y + cellY - 2 + 1] != player.initial or \
                    jeu.arrayGrid[x + cellX - 2 - 1][y + cellY - 2 - 0] != player.initial :